...
@RestController
@RequestMapping("/api/tmp-3-kafka")
public class Tmp3KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Tmp3KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Tmp3KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
